...
sudo mysql -u root -e "CREATE USER 'worduser'@'localhost' IDENTIFIED BY 'teamproton';"
...
ServerAdmin admin@teamproton.com
DocumentRoot /var/www/html/wordpress
ServerName teamproton.com
ServerAlias www.teamproton.com
